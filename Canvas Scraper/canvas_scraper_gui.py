...
class WebScraperGUI:
    def __init__(self):
        ...
        style.configure('TEntry', font=('Helvetica Neue', 10), background="gray", foreground="white")
        ...
        lab_label.grid(column=0, row=2, padx=5, pady=5)
        ...
        lab_dropdown.grid(column=1, row=2, padx=5, pady=5)

        # start button
        start_button = ttk.Button(self.window, text="Start", command=self.start_scraper)
        start_button.grid(column=1, row=3, padx=5, pady=5)
    ...
    def start_scraper(self):
        # code to start the scraper goes here
        pass
